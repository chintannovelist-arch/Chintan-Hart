...
const DecoderInputForm = React.memo(({ onDecode, isLoading }: { onDecode: (text: string) => void; isLoading: boolean; }) => {
...
DecoderInputForm.displayName = 'DecoderInputForm';


const DecoderResultDisplay = ({ analysis, isLoading }: { analysis: string; isLoading: boolean; }) => (
             ...
             <div className="max-w-6xl mx-auto px-6">
                <div className="grid lg:grid-cols-12 gap-16 items-start">
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <DecoderInputForm onDecode={handleDecode} isLoading={isLoading} />
                    </div>
                    <div className="lg:col-span-7">
                        <DecoderResultDisplay analysis={analysis} isLoading={isLoading} />
                    </div>
                </div>
             </div>
        </section>
