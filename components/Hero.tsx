      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 w-full max-w-[100vw] mx-auto h-full justify-center">
        ...
        <div className="animate-fade-in-up opacity-0 mb-10 md:mb-16 relative select-none p-4 w-full" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            <h1 className="font-display font-bold text-transparent bg-clip-text bg-gradient-to-b from-white via-slate-100 to-slate-400 drop-shadow-[0_0_35px_rgba(255,255,255,0.15)] flex flex-col items-center justify-center w-full">
                {/* Line 1: THE JASMINE */}
                <span className="block text-4xl sm:text-5xl md:text-7xl lg:text-[7.5rem] xl:text-[8.5rem] tracking-[0.15em] leading-[1.6] mb-2 md:mb-6 px-4 py-2 whitespace-nowrap">
                    THE JASMINE
                </span>
                {/* Line 2: KNOT */}
                <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-[9rem] xl:text-[11rem] tracking-[0.05em] leading-[1.2] text-white drop-shadow-[0_0_50px_rgba(37,150,190,0.4)] px-4 pb-4">
                    KNOT
                </span>
            </h1>
        </div>
        ...
        {introText && (
            <div className="animate-fade-in-up opacity-0 mb-12 md:mb-16 min-h-[4rem] flex items-center justify-center px-6 max-w-5xl" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
