...
const CharacterProfiles: React.FC = () => {
  ...
  // Parallax transforms
  const yOrbVijay = useTransform(scrollYProgress, [0, 1], ["-20%", "30%"]);
  const yOrbMeena = useTransform(scrollYProgress, [0, 1], ["20%", "-30%"]);
  const opacityOrbs = useTransform(scrollYProgress, [0, 0.5, 1], [0.2, 0.5, 0.2]);
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {/* Vijay's Atmosphere (Cool Blue) */}
          <motion.div 
            style={{ y: yOrbVijay, opacity: opacityOrbs }}
            className="absolute top-[-10%] right-[-10%] w-[800px] h-[800px] bg-primary/10 rounded-full blur-[120px] mix-blend-screen"
          />
          
          {/* Meena's Atmosphere (Warm Blush) */}
          <motion.div 
            style={{ y: yOrbMeena, opacity: opacityOrbs }}
            className="absolute bottom-[-10%] left-[-10%] w-[800px] h-[800px] bg-blush/10 rounded-full blur-[120px] mix-blend-screen"
          />
      ...
      <div className="max-w-[1600px] mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-stretch perspective-1000">
          {/* VIJAY - THE STORM */}
          <motion.div
            variants={stormCardVariants}
            className="relative flex flex-col p-10 md:p-14 border border-white/10 rounded-lg bg-black/50 backdrop-blur-xl shadow-glass overflow-hidden group"
          >
            ...
            />
            <div className="absolute inset-0 [mask-image:radial-gradient(ellipse_at_center,white_10%,transparent_60%)] bg-gradient-to-br from-primary/10 to-transparent group-hover:from-primary/20 transition-all duration-700"></div>

            <div className="relative z-10 flex flex-col h-full justify-between">
              <div className="space-y-8">
                <h3 className="font-display text-5xl md:text-7xl text-slate-200 tracking-[0.2em] group-hover:text-white transition-colors duration-500">VIJAY</h3>
                <p className="text-primary text-sm font-bold uppercase tracking-[0.3em]">The Architect of Order</p>
                <p className="font-body text-slate-400 text-lg md:text-xl leading-relaxed max-w-md mx-auto group-hover:text-slate-300 transition-colors duration-500">
              ...
              <div className="space-y-10 mt-16">
                <div className="relative group cursor-pointer w-fit mx-auto">
                    <blockquote className="font-display text-2xl text-slate-300 italic transition-all px-8 text-center group-hover:text-white leading-normal">
                        <ShimmeringText>
                          "A gentleman on the outside. A wildfire underneath."
                        </ShimmeringText>
                    </blockquote>
                    <Zap size={24} className="absolute top-1/2 -right-2 -translate-y-1/2 text-yellow-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 motion-safe:animate-pulse" aria-hidden="true" />
                </div>
                <div className="pt-8 border-t border-white/10">
                    <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Character Arc</h4>
                    <p className="text-sm md:text-base text-slate-500 italic max-w-md mx-auto leading-loose">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div className="space-y-8">
                <h3 className="font-display text-5xl md:text-7xl text-slate-200 tracking-[0.2em] group-hover:text-white transition-colors duration-500">MEENA</h3>
              ...
              <div className="space-y-10 mt-16">
                 <div className="relative group cursor-pointer w-fit mx-auto">
                    ...
                    <Flower2 size={24} className="absolute top-1/2 -right-2 -translate-y-1/2 text-blush opacity-0 group-hover:opacity-100 transition-opacity duration-300 motion-safe:animate-pulse" aria-hidden="true" />
                </div>
                 <div className="pt-8 border-t border-white/10">
                    <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4">Character Arc</h4>
                    <p className="text-sm md:text-base text-slate-500 italic max-w-md mx-auto leading-loose">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-left space-y-6 text-slate-400 font-body leading-relaxed text-lg text-justify columns-1 md:columns-2 gap-12">
              <p>
